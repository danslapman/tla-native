#!/usr/bin/env bash
# test-osx.sh - Run tlaplus/Examples models against the native TLC binary
#
# Usage:
#   ./test-osx.sh                    # run all models with runtime ≤60s
#   MAX_RUNTIME=30 ./test-osx.sh     # only run models that finish in ≤30s
